...
kubectl set image deployments/client-deployment server=rubhern/multi-client:$SHA
kubectl set image deployments/worker-deployment server=rubhern/multi-worker:$SHA